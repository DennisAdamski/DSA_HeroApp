...
void main() {
  test('talents list area is registered as list view with catalog support', () {
  ...
  test('talent special abilities area is registered as form view without visibility', () {
    final meta = workspaceAreaMetaById(WorkspaceAreaId.talentsSpecialAbilities);
